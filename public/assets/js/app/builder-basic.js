...
(function() {
    ...
    function setupFieldTypeButtons() {
        const fieldTypeButtons = document.querySelectorAll('.input-types .btn-col button');
        if (fieldTypeButtons.length > 0) {
    ...
    function addFieldToPreview(field) {
        ...
        fieldItem.className = 'preview-input-component row';
        ...
        fieldItem.innerHTML = `
            ...
            <div class="col-1">
                <button type="button" class="btn btn-link edit-field" data-field-id="${field.id}">
                    <i class="bi bi-pencil-square" style="color: var(--warning);"></i>
                </button>
            </div>
            <div class="col-1">
                <div class="drag-handle">
                    <i class="bi bi-grip-vertical" style="color: var(--secondary);"></i>
                </div>
            </div>
        `;
    ...
    function createInputHtml(field, index, value = '', isRemovable = false) {
        ...
        if (field.isMulti) {
            if (isRemovable) {
                ...
                addRemoveButton = `
                    <button type="button" class="btn btn-danger remove-field" data-field-key="${field.key}" data-index="${index}">
                ...
                addRemoveButton = `
                    <button type="button" class="btn btn-success add-field" data-field-key="${field.key}">
